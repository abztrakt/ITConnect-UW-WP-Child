<?php get_header(); ?>
		...
		<div id="primary">
			...
			<div class="row row-offcanvas row-offcanvas-left">
                ...
                <p class="pull-left visible-phone"><a href="#sidebar" class="btn btn-primary btn-offcanvas glyphicon-chevron-left glyphicon-white" data-toggle="offcanvas"></a>All</p>
				<div class="span9">
