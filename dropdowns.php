  <nav id="access" role="navigation" aria-label="Main menu">
    ...
    <div class="container">
        <div id="navbar-menu" class="navbar">
          <a class="btn btn-navbar visible-phone" data-toggle="collapse" data-target=".nav-collapse" title="Open Navigation" href="#menu" tabindex="0" role="button" aria-haspopup="true">
